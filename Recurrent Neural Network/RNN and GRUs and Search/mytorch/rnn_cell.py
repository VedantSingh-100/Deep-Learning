...
class RNNCell(object):
    ...
    def forward(self, x, h_prev_t):
        ...
        affine = ((np.dot(self.W_ih, x.T)) + (np.dot(self.W_hh, h_prev_t.T)) + self.b_ih[:, np.newaxis] + self.b_hh[:, np.newaxis]).T
        h_t = self.activation.forward(affine)
    ...
    def backward(self, delta, h_t, h_prev_l, h_prev_t):
        ...
        print(delta.shape)
        print(h_t.shape)
        print("Shape of h_prev_l is: ",h_prev_l.shape)
        ...
        print("Shape of dW_ih is: ",self.dW_ih.shape)
        self.dW_hh += np.dot(dz.T, h_prev_t) / batch_size
        print("Shape of dW_hh is: ",self.dW_hh.shape)
